// e2a-openapi-security-check protects security-scheme fields that oasdiff does
// not currently compare. It is an internal build tool, not a shipped command.
package main
...
func main() {
	...
	if err := openapicompat.CheckSecuritySchemes(base, revision); err != nil {
