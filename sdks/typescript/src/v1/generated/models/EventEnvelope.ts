...
export class EventEnvelope {
    'createdAt': Date;
    /**
    * Event-specific payload. Open at the envelope level; use x-e2a-event-data-schemas for stable event payloads.
    */
    'data': { [key: string]: any; };
    /**
    * Stable across retries and push channels; use it to deduplicate at-least-once delivery.
    */
    'id': string;
    /**
    * Open envelope-version string; the current server emits 1.
    */
    'schemaVersion': string;
    /**
    * Open event type; clients must tolerate unknown values.
    */
    'type': string;
    ...
    static getAttributeTypeMap() {
        return EventEnvelope.attributeTypeMap;
    }
