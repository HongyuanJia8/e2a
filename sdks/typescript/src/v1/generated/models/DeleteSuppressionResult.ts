...
export class DeleteSuppressionResult {
    /**
    * The un-suppressed recipient address.
    */
    'address': string;
    /**
    * Always true — the address is no longer suppressed. A failed delete is an error envelope, never deleted:false.
    */
    'deleted': boolean;
    ...
    static getAttributeTypeMap() {
        return DeleteSuppressionResult.attributeTypeMap;
    }
