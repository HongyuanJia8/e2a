...
export class DeleteWebhookResult {
    /**
    * Always true — the webhook no longer exists. A failed delete is an error envelope, never deleted:false.
    */
    'deleted': boolean;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return DeleteWebhookResult.attributeTypeMap;
    }
