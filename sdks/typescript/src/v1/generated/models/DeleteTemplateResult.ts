...
export class DeleteTemplateResult {
    /**
    * Always true — the template no longer exists. A failed delete is an error envelope, never deleted:false.
    */
    'deleted': boolean;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return DeleteTemplateResult.attributeTypeMap;
    }
