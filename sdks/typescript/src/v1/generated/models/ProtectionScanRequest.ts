...
export class ProtectionScanRequest {
    /**
    * Content-scan sensitivity: off disables; low|medium|high increase aggressiveness.
    */
    'sensitivity'?: ProtectionScanRequestSensitivityEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "ProtectionScanRequestSensitivityEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ProtectionScanRequest.attributeTypeMap;
    }
...
export enum ProtectionScanRequestSensitivityEnum {
    Off = 'off',
    Low = 'low',
    Medium = 'medium',
    High = 'high'
