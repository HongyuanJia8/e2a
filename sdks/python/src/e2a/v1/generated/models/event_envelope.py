...
class EventEnvelope(BaseModel):
    ...
    """ # noqa: E501
    created_at: datetime
    data: Dict[str, Any] = Field(description="Event-specific payload. Open at the envelope level; use x-e2a-event-data-schemas for stable event payloads.")
    id: StrictStr = Field(description="Stable across retries and push channels; use it to deduplicate at-least-once delivery.")
    schema_version: StrictStr = Field(description="Open envelope-version string; the current server emits 1.")
    type: StrictStr = Field(description="Open event type; clients must tolerate unknown values.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_at", "data", "id", "schema_version", "type"]
