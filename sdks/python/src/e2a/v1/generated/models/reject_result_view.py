...
class RejectResultView(BaseModel):
    """
    RejectResultView
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["message_id", "rejection_reason", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RejectResultView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RejectResultView from a dict"""
        if obj is None:
            return None
