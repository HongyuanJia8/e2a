...
class DeleteApiKeyResult(BaseModel):
    ...
    DeleteApiKeyResult
    """ # noqa: E501
    deleted: StrictBool = Field(description="Always true — the key is revoked. A failed delete is an error envelope, never deleted:false.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteApiKeyResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteApiKeyResult from a dict"""
        if obj is None:
            return None
