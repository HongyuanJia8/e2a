...
class EmailDeliveredData(BaseModel):
    """
    EmailDeliveredData
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["agent_email", "delivered_to", "direction", "message_id", "smtp_detail", "subject"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailDeliveredData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailDeliveredData from a dict"""
        if obj is None:
            return None
