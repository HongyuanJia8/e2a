...
class ProtectionDirectionRequest(BaseModel):
    """
    ProtectionDirectionRequest
    """ # noqa: E501
    gate: ProtectionGateRequest
    scan: ProtectionScanRequest
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProtectionDirectionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProtectionDirectionRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "gate": ProtectionGateRequest.from_dict(obj["gate"]) if obj.get("gate") is not None else None,
            "scan": ProtectionScanRequest.from_dict(obj["scan"]) if obj.get("scan") is not None else None
        })
