...
class DomainSendingVerifiedData(BaseModel):
    """
    DomainSendingVerifiedData
    """ # noqa: E501
    domain: StrictStr
    sending_status: StrictStr = Field(description="Terminal sending-identity status. Open set; tolerate unknown values. Known values: verified.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["domain", "sending_status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainSendingVerifiedData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainSendingVerifiedData from a dict"""
        if obj is None:
            return None
