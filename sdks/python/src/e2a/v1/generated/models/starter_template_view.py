...
class StarterTemplateView(BaseModel):
    """
    StarterTemplateView
    """ # noqa: E501
    alias: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["alias", "description", "name", "subject", "variables", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StarterTemplateView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StarterTemplateView from a dict"""
        if obj is None:
            return None
