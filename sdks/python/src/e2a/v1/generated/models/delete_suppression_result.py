...
class DeleteSuppressionResult(BaseModel):
    """
    DeleteSuppressionResult
    """ # noqa: E501
    address: StrictStr = Field(description="The un-suppressed recipient address.")
    deleted: StrictBool = Field(description="Always true — the address is no longer suppressed. A failed delete is an error envelope, never deleted:false.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "deleted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteSuppressionResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteSuppressionResult from a dict"""
        if obj is None:
            return None
