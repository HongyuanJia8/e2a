...
class RedeliverView(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedeliverView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedeliverView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "deliveries": [RedeliverDelivery.from_dict(_item) for _item in obj["deliveries"]] if obj.get("deliveries") is not None else None,
