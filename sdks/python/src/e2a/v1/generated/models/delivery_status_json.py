...
class DeliveryStatusJSON(BaseModel):
    """
    DeliveryStatusJSON
    """ # noqa: E501
    delivered: StrictInt
    failed: StrictInt
    matched_webhooks: StrictInt
    pending: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["delivered", "failed", "matched_webhooks", "pending"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryStatusJSON from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryStatusJSON from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "matched_webhooks": obj.get("matched_webhooks"),
