...
class UserExportUser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "email", "id", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserExportUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserExportUser from a dict"""
        if obj is None:
            return None
