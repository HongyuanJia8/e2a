...
class APIKeyExportEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "id", "key_prefix", "last_used_at", "name", "revoked_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIKeyExportEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIKeyExportEntry from a dict"""
        if obj is None:
            return None
