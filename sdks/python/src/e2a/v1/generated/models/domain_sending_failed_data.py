...
class DomainSendingFailedData(BaseModel):
    """
    DomainSendingFailedData
    """ # noqa: E501
    domain: StrictStr
    reason: Optional[StrictStr] = None
    sending_status: StrictStr = Field(description="Terminal sending-identity status. Open set; tolerate unknown values. Known values: failed.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["domain", "reason", "sending_status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainSendingFailedData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainSendingFailedData from a dict"""
        if obj is None:
            return None
