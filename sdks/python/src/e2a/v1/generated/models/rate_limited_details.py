...
class RateLimitedDetails(BaseModel):
    """
    RateLimitedDetails
    """ # noqa: E501
    retry_after_seconds: StrictInt = Field(description="Seconds to wait before retrying; mirrors the Retry-After response header. Always ≥ 1.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RateLimitedDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RateLimitedDetails from a dict"""
        if obj is None:
            return None
