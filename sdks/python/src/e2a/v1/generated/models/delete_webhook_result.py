...
class DeleteWebhookResult(BaseModel):
    ...
    DeleteWebhookResult
    """ # noqa: E501
    deleted: StrictBool = Field(description="Always true — the webhook no longer exists. A failed delete is an error envelope, never deleted:false.")
    id: StrictStr = Field(description="ID of the deleted webhook.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteWebhookResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteWebhookResult from a dict"""
        if obj is None:
            return None
