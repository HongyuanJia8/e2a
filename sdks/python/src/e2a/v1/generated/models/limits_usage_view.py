...
class LimitsUsageView(BaseModel):
    """
    LimitsUsageView
    """ # noqa: E501
    agents: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LimitsUsageView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LimitsUsageView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "messages_month": obj.get("messages_month"),
